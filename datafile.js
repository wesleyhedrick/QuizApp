const QUESTIONBANK = [
    ...
    {question: 'Could an African Swallow carry a coconut?', answer1:'Yes', answer2:	'No', answer3:	'There is no such thing.', answer4: 'Who is asking?', get correctAnswer() {return this.answer1}, feedback: 'It could carry one, but it wouldn\'t'},
    ...
    {question: 'What did the peasant woman say when Arthur insisted he was king of the Britons?', answer1: 'I didn\'t vote for you.', answer2: 'Beg pardon, \'majesty?', answer3: 'What is a king?', answer4: 'We are an anarcho-syndicalist commune.', get correctAnswer() {return this.answer1}, feedback: 'She and her husband were way ahead of their time.'}, 
    ...
    {question: 'Who was Arthur\'s most scientific knight?', answer1: 'Sir Longshanks', answer2: 'Sir Grendal', answer3: 'Sir Lancelot', answer4: 'Sir Bedivere', get correctAnswer() {return this.answer4}, feedback: 'He instructed the townsfolk how to know a which from an ordinary woman.'},
